...
// code on tient compte des categorie des partiucles
// #include "simulate.h"
// #include "univers.h"
// #include <iostream>
// #include <cmath>
...
//                                             // 🚀 **Nouvelle condition : Vérification de la catégorie**
//                                             if (p1->getCategorie() == p2->getCategorie()) {
//                                                 // ⚠️ On ignore le calcul de la force
//                                                 continue;
//                                             }

//                                             // Calcul de la force de Lennard-Jones si catégories différentes
//                                             Vecteur f = compute_LJ_force(*p1, *p2, epsilon, sigma);

//                                             // Mise à jour des forces pour chaque particule
//                                             forces[p1->getId()] = forces[p1->getId()] + f;
//                                             forces[p2->getId()] = forces[p2->getId()] - f;
//                                         }
//                                     }
